...
const articles: Article[] = [
  {
    ...
    excerpt:
      'Trường Tiểu học Vân Cốc thông báo kế hoạch tuyển sinh lớp 1 và các khối năm học 2026-2027.',
    thumbnailUrl: '/images/design/admission-2026-list.png',
    publishedAt: '2026-03-15T08:00:00Z',
    content: `
<img class="lqd-admission-banner" src="/images/design/admission-2026-detail.png" alt="Thông báo tuyển sinh năm học 2026-2027" />
<h2>Thông báo Tuyển sinh năm học 2026-2027</h2>
<p>Trường Tiểu học Vân Cốc trân trọng thông báo kế hoạch tuyển sinh năm học 2026-2027. Nhà trường tuyển sinh các khối lớp từ lớp 1 đến lớp 5, trong đó <strong>tuyển sinh lớp 1</strong> là trọng tâm với chỉ tiêu 210 học sinh (6 lớp, sĩ số tối đa 35 em/lớp).</p>
...
`,
  },
  {
    ...
    excerpt:
      'Thông tin tuyển sinh năm học 2025-2026 của Trường Tiểu học Vân Cốc — đã hoàn tất.',
    thumbnailUrl: '/images/design/admission-2025-list.png',
    publishedAt: '2025-03-10T08:00:00Z',
    content: `
<h2>Thông báo Tuyển sinh năm học 2025-2026</h2>
<p>Trường Tiểu học Vân Cốc thông báo kết quả tuyển sinh năm học 2025-2026 đã hoàn tất. Nhà trường xin cảm ơn sự quan tâm và tin tưởng của các bậc Phụ huynh. Bài viết này được lưu giữ để Phụ huynh tham khảo quy trình tuyển sinh cho các năm tiếp theo.</p>
...
<p>Học sinh Vân Cốc được hưởng chương trình giáo dục chuẩn của Bộ GD&ĐT kết hợp các chương trình bổ trợ: Tiếng Anh Cambridge (8 tiết/tuần), STEM (2 tiết/tuần), Kỹ năng sống, Âm nhạc quốc tế, Thể dục chuyên sâu và nhiều câu lạc bộ ngoại khóa phong phú.</p>
...
`,
  },
  {
    ...
    thumbnailUrl: '/images/design/hero-admission-2026.png',
    publishedAt: '2026-01-15T08:00:00Z',
    content: `
<h2>CLB Ngôi nhà mơ ước 2026</h2>
<p>Trường Tiểu học Vân Cốc trân trọng giới thiệu chương trình <strong>CLB Ngôi nhà mơ ước 2026</strong> — khóa học trải nghiệm miễn phí dành cho trẻ 5 tuổi đang chuẩn bị vào lớp 1. Đây là cơ hội để các bé và Phụ huynh làm quen với môi trường học tập tại Vân Cốc trước khi đưa ra quyết định chọn trường.</p>
...
<p>Khảo sát sau chương trình cho thấy <strong>98% phụ huynh</strong> đánh giá "Rất hài lòng" hoặc "Hài lòng". Chị Nguyễn Thu Hà, phụ huynh bé Gia Hân, chia sẻ: "Bé nhà tôi rất háo hức mỗi thứ Bảy đi học. Về nhà bé kể liên tục và đòi vào Vân Cốc. Chương trình giúp cả phụ huynh và con hiểu rõ hơn về trường."</p>
...
<p>Ngày 21 tháng 2 năm 2026, trường Tiểu học Vân Cốc tổ chức hội thảo <strong>"3 SẴN SÀNG cùng 1 năm đầu tiên"</strong> dành cho phụ huynh có con chuẩn bị vào lớp 1. Hội thảo thu hút hơn 150 phụ huynh tham dự trực tiếp và 200 phụ huynh theo dõi qua livestream.</p>
...
`,
  ...
  {
    title: 'Quy trình tuyển sinh và nhập học tại Vân Cốc',
    slug: 'quy-trinh-tuyen-sinh-va-nhap-hoc-tai-van-coc',
    excerpt:
      'Hướng dẫn chi tiết quy trình từ đăng ký, giao lưu đánh giá đến nhập học chính thức.',
    thumbnailUrl: '/images/design/admission-process.png',
    publishedAt: '2026-02-01T08:00:00Z',
    content: `
<h2>Quy trình Tuyển sinh và Nhập học</h2>
<p>Để giúp Phụ huynh hiểu rõ và chuẩn bị tốt nhất, Trường Tiểu học Vân Cốc xin hướng dẫn chi tiết quy trình tuyển sinh và nhập học năm học 2026-2027 gồm <strong>5 bước chính</strong>.</p>
...
<p>Phụ huynh có thắc mắc vui lòng liên hệ Phòng Tuyển sinh qua hotline <strong>024.3756.xxxx</strong> (giờ hành chính) hoặc email tuyensinh@vancoc.edu.vn.</p>
`,
  },
  {
...
<p>Trường Tiểu học Vân Cốc công bố chương trình học bổng năm học 2026-2027 với tổng giá trị <strong>hơn 500 triệu đồng</strong>, nhằm khuyến khích học sinh xuất sắc và hỗ trợ gia đình có hoàn cảnh khó khăn. Chương trình gồm 3 loại học bổng chính.</p>
...
<p>Trường Tiểu học Vân Cốc mở cửa chào đón Phụ huynh đến tham quan và tìm hiểu về nhà trường vào <strong>các ngày thứ Bảy hàng tuần</strong>, từ 8h30 đến 11h30. Đây là cơ hội để Phụ huynh trực tiếp trải nghiệm không gian học tập, gặp gỡ Ban Giám hiệu và đặt câu hỏi.</p>
