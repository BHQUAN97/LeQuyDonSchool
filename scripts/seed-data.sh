#!/bin/bash
# Script seed du lieu cho VanCoc qua API
# Su dung: bash scripts/seed-data.sh [BASE_URL]

BASE_URL="${1:-http://localhost:4200/api}"
ADMIN_EMAIL_VALUE="${ADMIN_EMAIL:-admin@lequydon.edu.vn}"
ADMIN_PASSWORD_VALUE="${ADMIN_PASSWORD:-Admin@123456}"
echo "=== SEED DATA cho VanCoc ==="
echo "API: $BASE_URL"
...
LOGIN_RES=$(curl -s -X POST "$BASE_URL/auth/login" \
  ...
  -d "{\"email\":\"$ADMIN_EMAIL_VALUE\",\"password\":\"$ADMIN_PASSWORD_VALUE\"}")
...
create_article \
  ...
  "Ban Giám hiệu Trường Tiểu học Vân Cốc gửi thư ngỏ tới toàn thể phụ huynh về công tác đảm bảo an toàn thực phẩm, nguồn gốc nguyên liệu và quy trình kiểm soát chất lượng bữa ăn học đường." \
  "<h2>Cam kết an toàn thực phẩm</h2><p>Kính gửi quý phụ huynh học sinh Trường Tiểu học Vân Cốc,</p><p>Trước sự quan tâm của dư luận về vấn đề an toàn thực phẩm trong trường học, Ban Giám hiệu nhà trường xin thông tin minh bạch đến quý phụ huynh về các biện pháp đảm bảo chất lượng bữa ăn:</p><h3>Nguồn cung ứng thực phẩm</h3><ul><li>100% thịt lợn, thịt bò từ trang trại GAP có giấy chứng nhận kiểm dịch</li><li>Rau củ quả từ vùng trồng VietGAP tại Mộc Châu, Sơn La</li><li>Gạo hữu cơ Japonica từ Ninh Bình</li><li>Sữa tươi Vinamilk organic đạt chuẩn châu Âu</li></ul><h3>Quy trình kiểm soát</h3><p>Mỗi ngày, đội ngũ y tế nhà trường thực hiện kiểm tra nguồn gốc, mẫu lưu thực phẩm 24h, và phối hợp với cơ quan y tế quận giám sát định kỳ hàng tháng.</p><p>Nhà trường luôn đặt sức khỏe và sự an toàn của học sinh lên hàng đầu.</p><p>Trân trọng,<br/>Ban Giám hiệu Trường Tiểu học Vân Cốc</p>" \
  "$CID" 2 "2025-10-15"

create_article \
  "Kết quả thi Olympic Toán cấp Quận năm 2026" \
  "ket-qua-olympic-toan-cap-quan-2026" \
  "Học sinh Trường Tiểu học Vân Cốc đạt thành tích xuất sắc tại kỳ thi Olympic Toán cấp Quận năm 2026 với 45 giải thưởng." \
  "<h2>45 giải thưởng Olympic Toán cấp Quận</h2><p>Trong kỳ thi Olympic Toán cấp Quận Nam Từ Liêm năm 2026, đội tuyển Toán của Trường Tiểu học Vân Cốc đã xuất sắc giành được 45 giải thưởng, bao gồm:</p><ul><li><strong>8 giải Nhất</strong> — cao nhất trong các trường tham gia</li><li><strong>12 giải Nhì</strong></li><li><strong>15 giải Ba</strong></li><li><strong>10 giải Khuyến khích</strong></li></ul><p>Đặc biệt, em Nguyễn Minh Anh (lớp 5A1) đạt điểm cao nhất toàn quận với 98/100 điểm. Em chia sẻ: <em>\"Em rất vui và biết ơn các thầy cô đã hướng dẫn em trong suốt quá trình ôn luyện.\"</em></p><p>Cô Nguyễn Thị Hương, trưởng bộ môn Toán, cho biết: \"Kết quả này là minh chứng cho phương pháp dạy học tích cực, phát huy tư duy sáng tạo mà nhà trường đã áp dụng trong nhiều năm qua.\"</p>" \
  "$CID" 3 "2026-01-20"

create_article \
  "Chương trình Tiếng Anh tăng cường hợp tác PLC Sydney" \
  "chuong-trinh-tieng-anh-plc-sydney" \
  "Trường Tiểu học Vân Cốc chính thức triển khai chương trình Tiếng Anh tăng cường hợp tác toàn diện với PLC Sydney (Úc) từ năm học 2025-2026." \
  "<h2>Hợp tác giáo dục quốc tế PLC Sydney</h2><p>Từ năm học 2025-2026, Trường Tiểu học Vân Cốc chính thức triển khai chương trình Tiếng Anh tăng cường với sự hợp tác toàn diện từ PLC Sydney — một trong những trường tư thục danh tiếng nhất nước Úc, có lịch sử hơn 130 năm.</p><h3>Nội dung chương trình</h3><ul><li>8 tiết Tiếng Anh/tuần (gấp đôi chương trình thông thường)</li><li>Giáo viên bản ngữ từ PLC Sydney giảng dạy trực tiếp</li><li>Tài liệu học tập theo chuẩn Cambridge International</li><li>Trao đổi học sinh trực tuyến với học sinh PLC Sydney</li><li>Chương trình Summer Camp tại Úc mỗi hè</li></ul><p>Với chương trình này, học sinh Vân Cốc sẽ đạt trình độ Tiếng Anh tương đương A2-B1 (CEFR) khi hoàn thành tiểu học, sẵn sàng cho các chương trình song ngữ cấp THCS.</p>" \
  "$CID" 4 "2025-08-20"

create_article \
  "Trường Tiểu học Vân Cốc đón Đoàn kiểm tra chất lượng giáo dục" \
  "don-doan-kiem-tra-chat-luong-giao-duc" \
  "Ngày 15/11/2025, Đoàn kiểm tra của Sở GD&ĐT Hà Nội đã đến kiểm tra và đánh giá cao chất lượng giáo dục tại Trường Tiểu học Vân Cốc." \
  "<h2>Đoàn kiểm tra Sở GD&ĐT Hà Nội đánh giá cao</h2><p>Ngày 15/11/2025, Đoàn kiểm tra của Sở GD&ĐT Hà Nội do ThS. Trần Văn Minh — Phó Giám đốc Sở dẫn đầu đã đến thăm và kiểm tra toàn diện hoạt động giáo dục tại Trường Tiểu học Vân Cốc.</p><p>Qua một ngày kiểm tra thực tế, Đoàn đánh giá:</p><ul><li>Cơ sở vật chất hiện đại, đạt chuẩn quốc tế</li><li>Chương trình giáo dục phong phú, chú trọng phát triển toàn diện</li><li>Đội ngũ giáo viên có chuyên môn cao, tận tâm với nghề</li><li>Công tác quản lý học sinh khoa học, minh bạch</li><li>Bữa ăn học đường đảm bảo dinh dưỡng và an toàn</li></ul><p>ThS. Trần Văn Minh nhận xét: <em>\"Trường Tiểu học Vân Cốc là một trong những trường tiểu học ngoài công lập tiêu biểu của Hà Nội, xứng đáng là mô hình để các trường khác tham khảo và học hỏi.\"</em></p>" \
  "$CID" 5 "2025-11-15"

create_article \
  "Phát động phong trào Giữ gìn vệ sinh trường học xanh - sạch - đẹp" \
  "phong-trao-truong-hoc-xanh-sach-dep" \
  "Trường Tiểu học Vân Cốc phát động phong trào 'Trường học xanh - sạch - đẹp' nhằm nâng cao ý thức bảo vệ môi trường cho học sinh." \
  "<h2>Trường học xanh - sạch - đẹp</h2><p>Ngày 20/10/2025, Trường Tiểu học Vân Cốc chính thức phát động phong trào \"Trường học xanh - sạch - đẹp\" với sự tham gia nhiệt tình của toàn thể cán bộ giáo viên và học sinh.</p><p>Phong trào bao gồm các hoạt động:</p><ul><li>Trồng cây xanh tại khuôn viên trường</li><li>Phân loại rác tại nguồn</li><li>Thi đua lớp học sạch đẹp nhất</li><li>Sáng kiến giảm rác thải nhựa</li></ul><p>Mỗi lớp được giao chăm sóc một bồn cây, học sinh luân phiên tưới nước và theo dõi sự phát triển. Hoạt động này không chỉ giúp làm đẹp khuôn viên mà còn giáo dục ý thức bảo vệ môi trường cho các em từ nhỏ.</p>" \
  "$CID" 6 "2025-10-20"

create_article \
  "Tổng kết học kỳ I năm học 2025-2026" \
  "tong-ket-hoc-ky-1-2025-2026" \
  "Trường Tiểu học Vân Cốc tổ chức lễ tổng kết học kỳ I với nhiều thành tích đáng tự hào: 95% học sinh đạt loại Tốt." \
  "<h2>Thành tích học kỳ I ấn tượng</h2><p>Chiều ngày 15/1/2026, Trường Tiểu học Vân Cốc long trọng tổ chức Lễ tổng kết học kỳ I năm học 2025-2026.</p><h3>Kết quả nổi bật</h3><ul><li>95% học sinh đạt loại Tốt</li><li>100% giáo viên hoàn thành tốt nhiệm vụ</li><li>45 giải Olympic Toán cấp Quận</li><li>32 giải Tiếng Anh cấp Thành phố</li><li>18 giải văn nghệ, thể thao các cấp</li></ul><p>Nhà trường trao 200 giấy khen cho học sinh có thành tích xuất sắc và 50 suất học bổng khuyến học. Buổi lễ kết thúc với chương trình văn nghệ đặc sắc do các em học sinh biểu diễn.</p>" \
  "$CID" 7 "2026-01-15"

create_article \
  "Chào đón Tết Nguyên đán 2026 tại Trường Vân Cốc" \
...
create_article \
  ...
  "<h2>Ứng dụng quản lý học sinh thông minh</h2><p>Từ tháng 10/2025, Trường Tiểu học Vân Cốc chính thức triển khai ứng dụng di động \"VC Connect\" trên cả iOS và Android.</p><h3>Tính năng chính</h3><ul><li>Xem kết quả học tập, nhận xét của giáo viên theo thời gian thực</li><li>Thời khóa biểu và lịch hoạt động ngoại khóa</li><li>Menu bữa ăn hàng ngày với thông tin dinh dưỡng</li><li>Đăng ký xe đưa đón, CLB ngoại khóa online</li><li>Chat trực tiếp với giáo viên chủ nhiệm</li><li>Nhận thông báo quan trọng từ nhà trường</li></ul><p>Ứng dụng nhận được phản hồi tích cực từ 90% phụ huynh sau 2 tuần sử dụng.</p>" \
  "$CID" 9 "2025-10-01"

create_article \
  "Giáo viên Vân Cốc đạt giải Giáo viên dạy giỏi cấp Thành phố" \
  "giao-vien-dat-giai-day-gioi-cap-thanh-pho" \
  "Cô Trần Thị Mai Hương đại diện Trường Tiểu học Vân Cốc xuất sắc đạt giải Nhất cuộc thi Giáo viên dạy giỏi cấp Thành phố Hà Nội." \
  "<h2>Vinh danh giáo viên xuất sắc</h2><p>Cô Trần Thị Mai Hương — giáo viên chủ nhiệm lớp 4A2 Trường Tiểu học Vân Cốc đã xuất sắc đạt giải Nhất cuộc thi Giáo viên dạy giỏi cấp Thành phố Hà Nội năm 2025.</p><p>Với bài giảng Toán lớp 4 chủ đề \"Phân số trong đời sống\", cô Hương đã sáng tạo phương pháp dạy học trải nghiệm, giúp học sinh tự khám phá kiến thức qua các hoạt động thực tế như đo lường nguyên liệu nấu ăn, chia phần bánh sinh nhật.</p><p>Cô chia sẻ: <em>\"Tôi luôn tin rằng mỗi đứa trẻ đều có tiềm năng riêng. Nhiệm vụ của giáo viên là tìm ra cách để khơi dậy niềm đam mê học tập trong mỗi em.\"</em></p><p>Đây là giải thưởng cá nhân thứ 3 của cô Hương trong 5 năm gần đây.</p>" \
  "$CID" 10 "2025-12-20"

create_article \
  "Chương trình Giáo dục STEM tại Trường Vân Cốc" \
  "chuong-trinh-giao-duc-stem" \
  "Trường Tiểu học Vân Cốc triển khai chương trình giáo dục STEM toàn diện với phòng Lab hiện đại và đội ngũ giáo viên chuyên biệt." \
  "<h2>STEM — Giáo dục cho tương lai</h2><p>Nhận thức tầm quan trọng của giáo dục STEM (Khoa học - Công nghệ - Kỹ thuật - Toán học) trong thời đại 4.0, Trường Tiểu học Vân Cốc đã đầu tư mạnh mẽ vào chương trình này từ năm học 2024-2025.</p><h3>Cơ sở vật chất</h3><ul><li>Phòng Lab STEM 120m² với thiết bị hiện đại</li><li>Bộ kit Robotics LEGO Education cho từng nhóm học sinh</li><li>Máy in 3D, máy cắt laser cho các dự án sáng tạo</li><li>Khu vườn thực nghiệm 50m² cho môn Khoa học</li></ul><h3>Chương trình học</h3><p>Mỗi tuần, học sinh từ lớp 3-5 có 2 tiết STEM, trong đó 1 tiết Robotics và 1 tiết dự án khoa học. Học sinh lớp 1-2 được làm quen qua các hoạt động thí nghiệm đơn giản và xây dựng mô hình.</p>" \
  "$CID" 11 "2025-09-15"

create_article \
  "Trường Vân Cốc tổ chức Ngày hội Đọc sách" \
  "ngay-hoi-doc-sach-2026" \
  "Ngày hội Đọc sách 2026 tại Trường Tiểu học Vân Cốc thu hút hơn 1.200 học sinh tham gia với nhiều hoạt động sáng tạo." \
  "<h2>Ngày hội Đọc sách 2026</h2><p>Hưởng ứng Ngày Sách và Văn hóa đọc Việt Nam 21/4, Trường Tiểu học Vân Cốc tổ chức Ngày hội Đọc sách với chủ đề \"Sách — Người bạn đồng hành\".</p><h3>Các hoạt động</h3><ul><li>Triển lãm sách với hơn 5.000 đầu sách các thể loại</li><li>Cuộc thi kể chuyện theo sách cho học sinh các khối</li><li>Workshop làm bookmark sáng tạo</li><li>Giao lưu với nhà văn Nguyễn Nhật Ánh</li><li>Quyên góp sách cho thư viện vùng cao</li></ul><p>Thư viện nhà trường cũng nhân dịp này bổ sung thêm 500 đầu sách mới, nâng tổng số lên hơn 15.000 cuốn, phục vụ nhu cầu đọc phong phú của học sinh.</p>" \
  "$CID" 12 "2026-04-10"

create_article \
  "Trường Vân Cốc tham gia Chương trình Sữa học đường Hà Nội" \
  "chuong-trinh-sua-hoc-duong" \
  "100% học sinh Trường Tiểu học Vân Cốc được uống sữa tươi organic mỗi ngày trong chương trình Sữa học đường." \
  "<h2>Sữa học đường — Dinh dưỡng cho sự phát triển</h2><p>Từ năm học 2025-2026, Trường Tiểu học Vân Cốc tham gia Chương trình Sữa học đường Hà Nội với 100% học sinh được uống sữa tươi organic Vinamilk mỗi ngày.</p><p>Chương trình nhằm cung cấp nguồn dinh dưỡng bổ sung calcium, vitamin D và protein cho học sinh, hỗ trợ phát triển chiều cao và trí não.</p><p>Mỗi buổi sáng, các em được uống 1 hộp sữa tươi 180ml trước giờ ra chơi. Y tế nhà trường theo dõi chiều cao, cân nặng học sinh mỗi quý để đánh giá hiệu quả chương trình.</p><p>Sau 1 học kỳ, chiều cao trung bình tăng 2.3cm, cao hơn 0.5cm so với mức trung bình cùng lứa tuổi.</p>" \
  "$CID" 13 "2025-11-01"
...
create_article \
  ...
  "<h2>Chuyến dã ngoại bổ ích</h2><p>Ngày 15/11/2025, 280 học sinh Khối 2 Trường Tiểu học Vân Cốc đã có chuyến dã ngoại thú vị tại Khu đô thị sinh thái Ecopark (Hưng Yên).</p><p>Chương trình dã ngoại bao gồm:</p><ul><li>Tham quan vườn bách thảo với hơn 100 loài cây</li><li>Hoạt động teambuilding: thi đấu giữa các nhóm</li><li>Thí nghiệm khoa học ngoài trời: đo pH đất, quan sát côn trùng</li><li>Picnic và trò chơi dân gian tại bãi cỏ</li><li>Vẽ tranh phong cảnh thiên nhiên</li></ul><p>Cô giáo chủ nhiệm lớp 2A3 chia sẻ: <em>\"Mỗi chuyến dã ngoại đều giúp các em tự tin hơn, biết cách hợp tác với bạn bè. Nhiều em lần đầu tiên được tiếp xúc với thiên nhiên một cách gần gũi như vậy.\"</em></p>" \
  "$CID" 4 "2025-11-15"

create_article \
  "Cuộc thi Hùng biện Tiếng Anh Vân Cốc 2026" \
...
create_article \
  "CLB Robotics Vân Cốc — Hành trình sáng tạo" \
...
create_article \
  ...
  "<h2>CLB Nghệ thuật</h2><p>CLB Nghệ thuật Vân Cốc gồm 2 bộ môn chính:</p><h3>Hội họa</h3><ul><li>Vẽ tranh sáp dầu, màu nước, acrylic</li><li>Điêu khắc đất sét</li><li>Nghệ thuật cắt giấy origami</li><li>Triển lãm tranh học sinh mỗi quý</li></ul><h3>Âm nhạc</h3><ul><li>Piano, violin, guitar cơ bản</li><li>Hợp xướng và đơn ca</li><li>Nhạc cụ dân tộc: đàn tranh, sáo trúc</li><li>Biểu diễn tại các sự kiện trường</li></ul><p>CLB đã đạt 15 giải thưởng cấp Quận và Thành phố trong năm 2025 ở cả 2 bộ môn.</p>" \
  "$CID" 3 "2025-11-10"
...
create_article \
  ...
  "Trường Tiểu học Vân Cốc cung cấp hệ thống thư viện số với hàng nghìn tài liệu, video bài giảng và bài tập trực tuyến." \
  "<h2>Thư viện số Vân Cốc</h2><p>Từ năm 2024, Trường Tiểu học Vân Cốc triển khai hệ thống thư viện số, bổ sung cho thư viện vật lý 15.000 cuốn sách:</p><h3>Tài nguyên số</h3><ul><li>5.000+ ebook tiếng Việt và tiếng Anh</li><li>500+ video bài giảng theo chương trình</li><li>2.000+ bài tập trực tuyến tự chấm</li><li>Kho đề thi các năm trước</li><li>Sách nói cho học sinh thích nghe</li></ul><h3>Cách truy cập</h3><p>Học sinh đăng nhập qua ứng dụng VC Connect hoặc website trường với tài khoản được cấp. Phụ huynh có thể theo dõi lịch sử đọc sách của con.</p><p>Trung bình mỗi ngày có 300 lượt truy cập thư viện số, cao nhất vào khung 19:00-21:00.</p>" \
  "$CID" 8 "2025-10-15"
...
create_article \
  ...
  "<h2>Học phí và hỗ trợ tài chính</h2><p>Trường Tiểu học Vân Cốc cam kết mức học phí phù hợp với chất lượng giáo dục hàng đầu:</p><h3>Học phí năm 2026-2027</h3><ul><li>Học phí: từ 8.5 triệu/tháng (10 tháng/năm)</li><li>Bao gồm: học phí, Tiếng Anh tăng cường, STEM, bữa ăn chính</li><li>Chưa bao gồm: xe đưa đón, CLB ngoại khóa tự chọn</li></ul><h3>Chính sách hỗ trợ</h3><ul><li>Học bổng xuất sắc: Miễn 50-100% học phí cho học sinh giỏi toàn diện</li><li>Hỗ trợ anh chị em: Giảm 10% cho gia đình có 2+ con học tại trường</li><li>Trả góp: Hỗ trợ trả góp 0% lãi suất qua ngân hàng đối tác</li></ul>" \
  "$CID" 1 "2026-01-15"

create_article \
  "Ngày hội Tuyển sinh Vân Cốc Open Day 2026" \
...
create_article \
  "Câu hỏi thường gặp về tuyển sinh Vân Cốc" \
...
create_article \
  ...
  "<h2>Xe đưa đón an toàn</h2><p>Trường Tiểu học Vân Cốc vận hành 10 tuyến xe buýt đưa đón học sinh:</p><h3>An toàn</h3><ul><li>Xe 29-45 chỗ, đạt tiêu chuẩn an toàn ĐKVN</li><li>GPS tracking — phụ huynh theo dõi qua app</li><li>Camera giám sát 360 độ trong xe</li><li>Mỗi xe có 1 bảo mẫu đi kèm</li><li>Tài xế được đào tạo lái xe an toàn cho trẻ em</li></ul><h3>Tuyến đường</h3><p>Phủ các quận: Nam Từ Liêm, Bắc Từ Liêm, Cầu Giấy, Thanh Xuân, Hà Đông, Đống Đa, Ba Đình, Hoàng Mai, Long Biên, Hai Bà Trưng.</p><p>Lịch xe: Sáng đón 6:30-7:15, chiều trả 16:45-17:30. Phụ huynh nhận thông báo khi xe đến điểm đón/trả.</p>" \
  "$CID" 2 "2025-10-10"
...
create_article \
  ...
  "<h2>Một ngày tại Vân Cốc</h2><h3>Lịch sinh hoạt</h3><ul><li><strong>7:15 — 7:30:</strong> Đón học sinh, thể dục sáng</li><li><strong>7:30 — 8:00:</strong> Ăn sáng tại trường</li><li><strong>8:00 — 11:15:</strong> 4 tiết học buổi sáng</li><li><strong>11:15 — 11:30:</strong> Bữa phụ (sữa/trái cây)</li><li><strong>11:30 — 12:00:</strong> Ăn trưa</li><li><strong>12:00 — 13:30:</strong> Nghỉ trưa (phòng nghỉ có giường)</li><li><strong>13:30 — 15:30:</strong> 2-3 tiết học buổi chiều</li><li><strong>15:30 — 15:45:</strong> Bữa phụ chiều</li><li><strong>15:45 — 16:45:</strong> CLB ngoại khóa / Tự học có giáo viên</li><li><strong>16:45 — 17:00:</strong> Trả học sinh / Lên xe đưa về</li></ul><p>Phụ huynh đón muộn (sau 17:00) có dịch vụ trông giữ đến 18:00 với phí bổ sung.</p>" \
  "$CID" 6 "2025-08-25"

create_article \
  "Đồng phục học sinh Vân Cốc — Phong cách và thoải mái" \
  "dong-phuc-hoc-sinh-phong-cach" \
  "Bộ đồng phục mới thiết kế năm 2025 với chất liệu thoáng mát, phù hợp khí hậu Việt Nam." \
  "<h2>Đồng phục học sinh</h2><p>Bộ đồng phục Trường Tiểu học Vân Cốc được thiết kế lại năm 2025 với phong cách trẻ trung, hiện đại:</p><h3>Các bộ đồng phục</h3><ul><li><strong>Đồng phục hàng ngày:</strong> Áo polo trắng + quần/váy xanh navy — chất liệu cotton organic thoáng mát</li><li><strong>Đồng phục lễ:</strong> Sơ mi trắng + vest xanh + cà vạt/nơ đỏ</li><li><strong>Đồng phục thể thao:</strong> Áo thun + quần short — chất liệu thể thao thoáng khí</li><li><strong>Áo khoác mùa đông:</strong> Áo khoác lông cừu xanh navy có logo trường</li></ul><p>Đồng phục được bán tại trường đầu năm học. Phụ huynh có thể đặt thêm qua ứng dụng VC Connect.</p>" \
  "$CID" 7 "2025-07-15"
...
create_event "Ngày hội Tuyển sinh Open Day" "Trải nghiệm môi trường học tập tại Trường Tiểu học Vân Cốc" "2026-04-12" "2026-04-12" "Trường Tiểu học Vân Cốc" "upcoming"
...
create_event "Summer Camp 2026" "Trại hè 3 tuần với STEM, thể thao, nghệ thuật" "2026-06-15" "2026-07-05" "Trường Tiểu học Vân Cốc" "upcoming"
...
create_admission "Hướng dẫn tuyển sinh lớp 1" "huong-dan-tuyen-sinh-lop-1" "<h2>Tuyển sinh lớp 1</h2><p>Hướng dẫn chi tiết quy trình tuyển sinh lớp 1 tại Trường Tiểu học Vân Cốc năm học 2026-2027.</p><ul><li>Đối tượng: Trẻ sinh năm 2020</li><li>Chỉ tiêu: 175 học sinh</li><li>Hồ sơ: Nộp từ 01/3 đến 30/6/2026</li></ul>"
...
create_admission "Chương trình học tại Vân Cốc" "chuong-trinh-hoc-van-coc" "<h2>Chương trình Quốc gia nâng cao</h2><p>Chương trình học tại Trường Tiểu học Vân Cốc kết hợp chuẩn Quốc gia với Tiếng Anh tăng cường và STEM.</p>"
...
create_faq "Xe đưa đón hoạt động như thế nào?" "Trường có 10 tuyến xe buýt phủ các quận nội thành. Mỗi xe có GPS tracking, camera giám sát và bảo mẫu đi kèm. Phụ huynh theo dõi vị trí xe qua ứng dụng VC Connect." 3
