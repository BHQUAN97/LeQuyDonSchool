/**
 * Seed du lieu con thieu cho VanCoc qua API
...
function getFailedArticles(catMap) {
  return [
    // TIN TUC
    {
      title: 'Trường Tiểu học Vân Cốc khai giảng năm học 2025-2026',
    ...
    },
    {
      ...
      excerpt: 'Ngày 10/9/2025, Trường Tiểu học Vân Cốc tổ chức buổi họp phụ huynh đầu năm.',
    ...
    },
    {
      ...
      excerpt: 'Học sinh Trường Tiểu học Vân Cốc đạt thành tích xuất sắc tại kỳ thi Olympic Toán cấp Quận năm 2026 với 45 giải thưởng.',
    ...
    {
      title: 'Trường Tiểu học Vân Cốc đón Đoàn kiểm tra chất lượng giáo dục',
    ...
    },
    {
      ...
      content: '<h2>Trường học xanh - sạch - đẹp</h2><p>Ngày 20/10/2025, Trường Tiểu học Vân Cốc chính thức phát động phong trào với sự tham gia nhiệt tình của toàn thể cán bộ giáo viên và học sinh.</p><p>Phong trào bao gồm các hoạt động:</p><ul><li>Trồng cây xanh tại khuôn viên trường</li><li>Phân loại rác tại nguồn</li><li>Thi đua lớp học sạch đẹp nhất</li><li>Sáng kiến giảm rác thải nhựa</li></ul><p>Mỗi lớp được giao chăm sóc một bồn cây, học sinh luân phiên tưới nước và theo dõi sự phát triển.</p>',
      categoryId: catMap['tin-tuc'], thumbnailUrl: img(6), status: 'published', publishedAt: '2025-10-20T08:00:00.000Z',
    },
    {
      title: 'Trường Tiểu học Vân Cốc ra mắt ứng dụng quản lý học sinh',
    ...
    {
      title: 'Giáo viên Vân Cốc đạt giải Giáo viên dạy giỏi cấp Thành phố',
    ...
    {
      title: 'Ngày hội Đọc sách tại Trường Vân Cốc 2026',
    ...
    {
      title: 'Học sinh Vân Cốc tham gia thiện nguyện vùng cao',
    ...
    },
    {
      ...
      slug: 'hoc-qua-du-an-pbl-van-coc',
...
async function main() {
  ...
  const faqs = [
    ...
    { question: 'Xe đưa đón hoạt động như thế nào?', answer: 'Trường có 10 tuyến xe buýt phủ các quận nội thành. Mỗi xe có GPS tracking, camera giám sát và bảo mẫu đi kèm. Phụ huynh theo dõi vị trí xe qua ứng dụng VC Connect.', displayOrder: 3, isVisible: true },
