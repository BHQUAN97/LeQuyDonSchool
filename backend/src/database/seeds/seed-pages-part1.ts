...
/**
 * Seed 9 trang noi dung chinh (Pages Part 1) cho website truong tieu hoc Van Coc.
...
const pagesData: Array<{
  ...
  // ═══════════════════════════════════════════════════
  {
    title: 'Tổng quan về trường Tiểu học Vân Cốc',
    slug: 'tong-quan',
    status: PageStatus.PUBLISHED,
    seo_title: 'Tổng quan — Trường Tiểu học Vân Cốc',
    seo_description:
      'Giới thiệu tổng quan về trường Tiểu học Vân Cốc Hà Nội — lịch sử thành lập, vị trí, quy mô và triết lý giáo dục toàn diện.',
    content: `<section class="page-content">
<div class="lqd-split"><img src="/images/design/intro-classroom.png" alt="Học sinh trường Vân Cốc trong lớp học" /><div><h2>Trường Tiểu học Vân Cốc — Nơi ươm mầm tương lai</h2>
<p>Trường Tiểu học Vân Cốc tọa lạc tại quận Đống Đa, thành phố Hà Nội — trung tâm văn hóa và giáo dục của cả nước. Được thành lập vào năm <strong>1995</strong>, nhà trường mang tên vị danh nhân, nhà bác học lỗi lạc <em>Vân Cốc</em> (1726–1784) như một lời cam kết gìn giữ và phát huy truyền thống hiếu học của dân tộc Việt Nam. Trải qua gần 30 năm hình thành và phát triển, nhà trường đã trở thành một trong những địa chỉ giáo dục tiểu học uy tín và được tin tưởng hàng đầu tại Hà Nội.</p>
</div></div>

<div class="lqd-split lqd-reverse"><img src="/images/design/intro-campus-sanitizing.png" alt="Khuôn viên trường Vân Cốc" /><div><h2>Vị trí và cơ sở vật chất</h2>
...
<p>Trường Tiểu học Vân Cốc theo đuổi triết lý giáo dục <em>"Phát triển toàn diện Trí — Đức — Thể — Mỹ"</em>. Nhà trường không chỉ chú trọng đến thành tích học thuật mà còn đặc biệt quan tâm đến sự phát triển đạo đức, thể chất và cảm thụ nghệ thuật của mỗi học sinh. Chương trình học phong phú, kết hợp kiến thức phổ thông với các hoạt động trải nghiệm, ngoại khóa và giáo dục kỹ năng sống, giúp học sinh phát triển hài hòa và toàn diện ngay từ những năm đầu đời.</p>
...
<p>Trường Tiểu học Vân Cốc tự hào xây dựng được một cộng đồng gắn kết bền vững giữa nhà trường, gia đình và xã hội. Ban đại diện cha mẹ học sinh hoạt động tích cực, đồng hành cùng nhà trường trong nhiều chương trình giáo dục và hoạt động ngoại khóa. Mạng lưới cựu học sinh ngày càng mở rộng với hơn 5.000 thành viên, nhiều người đã và đang đóng góp tích cực cho sự phát triển của trường — từ hỗ trợ học bổng, chia sẻ kinh nghiệm đến đồng tổ chức các sự kiện cộng đồng. Đây chính là nền tảng vững chắc giúp nhà trường không ngừng phát triển và vươn lên trong thời đại mới.</p>
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    seo_description:
      'Tầm nhìn, sứ mệnh và bốn giá trị cốt lõi của trường Tiểu học Vân Cốc — nơi giáo dục toàn diện Trí, Đức, Thể, Mỹ.',
    content: `<section class="page-content">
<h2>Tầm nhìn — Hướng đến ngôi trường hàng đầu Hà Nội</h2>
<p>Trường Tiểu học Vân Cốc đặt mục tiêu trở thành <strong>ngôi trường tiểu học hàng đầu tại Hà Nội</strong> — một môi trường giáo dục tiên tiến, nhân văn và sáng tạo, nơi mỗi học sinh được phát hiện, nuôi dưỡng và phát huy tối đa tiềm năng của mình. Đến năm 2030, nhà trường phấn đấu đạt chuẩn quốc gia mức độ 2, trở thành địa chỉ giáo dục được gia đình Hà Nội và khu vực tin tưởng lựa chọn, đồng thời là mô hình tham chiếu cho các trường tiểu học trong cả nước.</p>

<h2>Sứ mệnh — Đồng hành cùng gia đình, kiến tạo tương lai</h2>
<p>Sứ mệnh của trường Tiểu học Vân Cốc là <strong>xây dựng môi trường giáo dục an toàn, thân thiện và truyền cảm hứng</strong>, nơi mỗi học sinh được giáo dục toàn diện về <em>Trí — Đức — Thể — Mỹ</em>. Nhà trường cam kết đồng hành cùng mỗi gia đình trong hành trình nuôi dưỡng con trẻ: trang bị kiến thức nền tảng, rèn luyện phẩm chất đạo đức, phát triển thể lực và khơi dậy tâm hồn yêu cái đẹp — để mỗi học sinh ra trường là một công dân trẻ tự tin, nhân ái và sáng tạo.</p>

<h2>Bốn giá trị cốt lõi</h2>
<p>Bốn giá trị cốt lõi tạo nên bản sắc và kim chỉ nam của mọi hoạt động giáo dục tại Vân Cốc:</p>
<ul>
...
<p>Triết lý giáo dục của Vân Cốc được đúc kết trong câu nói <em>"Mỗi em học sinh là một ngôi sao sáng"</em>. Mỗi trẻ em đều được sinh ra với những tài năng, cá tính và tiềm năng riêng biệt. Vai trò của nhà trường không phải là tạo ra những học sinh giống nhau, mà là tạo điều kiện để mỗi em được tỏa sáng theo cách riêng của mình — dù là qua toán học, tiếng Anh, hội họa, âm nhạc hay thể thao. Đây là lý do nhà trường đặc biệt chú trọng các hoạt động phong trào, câu lạc bộ và chương trình năng khiếu song song với học tập chính khóa.</p>
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    seo_description:
      'Hành trình 30 năm phát triển của trường Tiểu học Vân Cốc từ 1995 đến 2025 — những dấu mốc quan trọng định hình ngôi trường hôm nay.',
    content: `<section class="page-content">
<h2>Hành trình 30 năm xây dựng và phát triển</h2>
<p>Nhìn lại hành trình gần 30 năm, trường Tiểu học Vân Cốc đã trải qua nhiều giai đoạn phát triển đáng tự hào. Từ một ngôi trường nhỏ với cơ sở vật chất còn khiêm tốn, nhà trường đã không ngừng đổi mới, mở rộng và nâng cấp để trở thành một trong những trường tiểu học được đánh giá cao nhất tại quận Đống Đa và thành phố Hà Nội. Dưới đây là những cột mốc quan trọng đánh dấu từng bước trưởng thành của ngôi trường.</p>

<h3>1995 — Thành lập trường</h3>
<p>Trường Tiểu học Vân Cốc chính thức được thành lập theo Quyết định của UBND quận Đống Đa, thành phố Hà Nội. Khóa học sinh đầu tiên gồm 6 lớp với gần 200 em được đón nhận vào mái trường mang tên vị danh nhân lỗi lạc của dân tộc. Đội ngũ sáng lập bao gồm 15 giáo viên tâm huyết và Ban giám hiệu đầu tiên với quyết tâm xây dựng một mô hình giáo dục tiểu học chất lượng cao cho con em nhân dân quận Đống Đa.</p>

<h3>2000 — Đạt chuẩn quốc gia lần đầu tiên</h3>
<p>Sau 5 năm nỗ lực, trường Tiểu học Vân Cốc vinh dự được Bộ GD&ĐT công nhận đạt <strong>chuẩn quốc gia mức độ 1</strong> — một cột mốc quan trọng khẳng định chất lượng giáo dục và cơ sở vật chất của nhà trường. Đây là nguồn động lực to lớn cho toàn thể thầy cô, học sinh và phụ huynh, mở ra giai đoạn phát triển mới với nhiều chương trình đầu tư và nâng cấp toàn diện.</p>
...
<p>Nhà trường đặc biệt đầu tư vào cơ sở vật chất thể thao, thể hiện cam kết với việc phát triển thể chất toàn diện cho học sinh. Khu thể thao bao gồm: <strong>bể bơi 4 làn tiêu chuẩn</strong> được vận hành quanh năm với hệ thống lọc nước hiện đại, <strong>sân bóng đá mini trải cỏ nhân tạo</strong> đủ điều kiện tổ chức thi đấu, sân bóng rổ và cầu lông. Tất cả các hoạt động thể thao đều được hướng dẫn bởi giáo viên và huấn luyện viên chuyên nghiệp, đảm bảo an toàn tuyệt đối cho học sinh.</p>
  ...
  // ═══════════════════════════════════════════════════
  // PAGE 5: tong-quan/sac-mau-van-coc
  // ═══════════════════════════════════════════════════
  {
    title: 'Sắc màu Vân Cốc',
    slug: 'tong-quan/sac-mau-van-coc',
    status: PageStatus.PUBLISHED,
    seo_title: 'Sắc màu Vân Cốc — Văn hóa và bản sắc trường',
    seo_description:
      'Khám phá văn hóa trường Tiểu học Vân Cốc — đồng phục xanh navy, logo ngôi sao, slogan và những truyền thống đặc sắc tạo nên bản sắc riêng của Đôners.',
    content: `<section class="page-content">
<h2>Bản sắc văn hóa — Điều làm nên một Đôners</h2>
<p>Mỗi trường học đều có văn hóa riêng — những giá trị, biểu tượng và truyền thống tạo nên sợi dây gắn kết giữa các thế hệ học sinh, giáo viên và phụ huynh. Tại Vân Cốc, văn hóa trường được gọi là <em>"Sắc màu Đôners"</em> — một tập hợp những biểu tượng, nghi lễ và truyền thống tươi vui, ý nghĩa, tạo nên bản sắc riêng biệt không thể nhầm lẫn của ngôi trường thân yêu này. Là một Đôners không chỉ là mặc đồng phục đến trường — đó là thuộc về một cộng đồng với những giá trị và ký ức chung.</p>

<h2>Đồng phục — Xanh navy và trắng tinh khôi</h2>
<p>Đồng phục trường Tiểu học Vân Cốc mang tông màu chủ đạo <strong>xanh navy và trắng</strong> — sự kết hợp toát lên vẻ nghiêm túc, thanh lịch và trẻ trung. Áo sơ mi trắng với viền xanh navy và logo trường thêu tinh tế trên ngực trái; quần/váy xanh navy với đường may gọn gàng. Chiếc cà vạt xanh nhỏ cho học sinh nam và nơ xanh cho học sinh nữ là điểm nhấn đáng yêu tạo nên hình ảnh học sinh Vân Cốc chỉn chu, lễ phép. Mỗi buổi sáng, hàng trăm bộ đồng phục xanh trắng tụ hội trước cổng trường là hình ảnh đẹp đã trở thành thương hiệu của Vân Cốc.</p>

<h2>Logo và slogan — Biểu tượng của tri thức và khát vọng</h2>
<p>Logo trường Tiểu học Vân Cốc là hình ảnh <strong>ngọn bút lông và ngôi sao năm cánh</strong> — biểu tượng kết hợp giữa tri thức truyền thống (ngọn bút, gợi nhớ nhà bác học Vân Cốc và truyền thống hiếu học) và khát vọng tương lai (ngôi sao sáng trên bầu trời). Màu xanh navy và vàng gold của logo tạo nên sự trang trọng và ấm áp. Slogan chính thức của trường là <em>"Học để sáng tạo"</em> — nhắn nhủ học sinh không chỉ tiếp thu kiến thức mà còn biết ứng dụng, sáng tạo và tạo ra giá trị từ những gì đã học.</p>

<h2>Lễ chào cờ — Nghi lễ gắn kết cộng đồng</h2>
<p>Mỗi thứ Hai đầu tuần, toàn thể học sinh và giáo viên trường Tiểu học Vân Cốc tập trung tại sân trường trong <strong>Lễ chào cờ trang trọng</strong>. Đây không chỉ là nghi lễ chính trị mà còn là dịp để cả trường kết nối, nhìn lại tuần qua và đặt ra mục tiêu cho tuần mới. Học sinh xuất sắc được vinh danh, các câu lạc bộ công bố hoạt động mới, thông báo các sự kiện sắp tới. Đội Nghi lễ của trường — gồm học sinh lớp 4 và 5 được tuyển chọn và tập luyện nghiêm túc — thực hiện lễ chào cờ với tác phong chuyên nghiệp và đáng tự hào.</p>

<h2>Sinh nhật tập thể và Ngày hội sắc màu</h2>
<p>Hai sự kiện văn hóa nổi bật nhất của Vân Cốc là <strong>Sinh nhật tập thể</strong> và <strong>Ngày hội sắc màu</strong>. Sinh nhật tập thể được tổ chức mỗi tháng một lần, tôn vinh tất cả học sinh có ngày sinh trong tháng đó — tạo cho mỗi em cảm giác đặc biệt và được cộng đồng trường quan tâm. Ngày hội sắc màu Vân Cốc (tổ chức vào tháng 4 hằng năm) là ngày hội lớn nhất của trường, nơi học sinh mặc trang phục màu sắc rực rỡ đại diện cho lớp mình, tham gia hàng chục hoạt động nghệ thuật, thể thao và trò chơi dân gian trong không khí vui tươi, đoàn kết và đầy ắp tiếng cười.</p>
</section>`,
  },
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    status: PageStatus.PUBLISHED,
    seo_title: 'Gia đình Đôners — Cộng đồng trường Tiểu học Vân Cốc',
    seo_description:
...
<p>Điều làm nên sức mạnh của cộng đồng Đôners không phải là số lượng thành viên, mà là <strong>tinh thần gắn kết và hỗ trợ lẫn nhau</strong> thấm sâu vào từng cá nhân. Một Đôners khi gặp khó khăn luôn có thể tìm đến cộng đồng — dù đó là tìm lời khuyên nghề nghiệp, hỗ trợ học bổng, hay đơn giản chỉ là cần một người lắng nghe và chia sẻ. Tinh thần "Đôners yêu Đôners" này không được giảng dạy trong lớp học, mà được trao truyền tự nhiên qua văn hóa trường, qua những kỷ niệm đẹp được tạo ra trong suốt 5 năm tiểu học — những năm tháng quan trọng nhất trong hành trình trưởng thành của mỗi con người.</p>
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    status: PageStatus.PUBLISHED,
    seo_title: 'Tiếng Anh tăng cường — Chương trình Cambridge YLE tại Vân Cốc',
    seo_description:
...
<p>Trong bối cảnh hội nhập quốc tế sâu rộng, năng lực tiếng Anh là <strong>chìa khóa mở ra mọi cánh cửa</strong> cho thế hệ trẻ Việt Nam. Trường Tiểu học Vân Cốc hiểu rõ điều này và đã đưa <strong>chương trình Tiếng Anh tăng cường</strong> vào giảng dạy từ lớp 1 — sớm hơn nhiều so với yêu cầu của Bộ GD&ĐT. Với 4 tiết tiếng Anh mỗi tuần (gấp đôi chương trình chuẩn), học sinh Vân Cốc được tiếp xúc với tiếng Anh đủ nhiều và đủ sâu để thực sự làm chủ ngôn ngữ, chứ không chỉ học đối phó với bài kiểm tra.</p>

<h2>Giáo viên bản ngữ — Môi trường ngôn ngữ đích thực</h2>
<p>Điểm đặc biệt nhất của chương trình Tiếng Anh tại Vân Cốc là sự tham gia của <strong>giáo viên bản ngữ đến từ Anh, Mỹ và Úc</strong>. Các thầy cô người nước ngoài này không chỉ mang đến phát âm chuẩn xác mà còn mang cả văn hóa, tư duy và phong cách giao tiếp của người bản xứ vào lớp học. Mỗi lớp học đều có ít nhất 2 tiết/tuần với giáo viên bản ngữ, đảm bảo học sinh được thực hành giao tiếp thực tế trong môi trường ngôn ngữ đích thực. Phương pháp TPR (Total Physical Response) và task-based learning được áp dụng linh hoạt, biến mỗi tiết học thành một trải nghiệm ngôn ngữ vui vẻ và hiệu quả.</p>

<h2>Chương trình Cambridge YLE — Chuẩn mực quốc tế</h2>
<p>Nhà trường là <strong>Trung tâm được Cambridge Assessment English ủy quyền</strong> tổ chức thi chứng chỉ Young Learners English (YLE) ngay tại trường. Chương trình học được thiết kế theo lộ trình Cambridge: <em>Starters</em> (lớp 2–3), <em>Movers</em> (lớp 3–4) và <em>Flyers</em> (lớp 4–5) — tương ứng với 3 cấp độ tăng dần từ cơ bản đến nâng cao. Tỷ lệ đạt chứng chỉ của học sinh Vân Cốc liên tục ở mức cao: <strong>hơn 90%</strong> học sinh dự thi đạt chứng chỉ Cambridge YLE tương ứng với cấp độ của mình.</p>
...
<p>Sau hơn 15 năm triển khai chương trình Tiếng Anh tăng cường, những con số đã nói lên tất cả: <strong>hơn 90%</strong> học sinh tốt nghiệp lớp 5 đạt chứng chỉ Cambridge Movers hoặc Flyers; nhiều học sinh đạt điểm tuyệt đối (Shield) trong các kỳ thi Cambridge YLE; đội tuyển Tiếng Anh của trường nhiều năm liên tiếp giành giải nhất cuộc thi Tiếng Anh cấp quận và cấp thành phố; học sinh tốt nghiệp Vân Cốc tự tin giao tiếp với người nước ngoài, sẵn sàng học tiếp chương trình song ngữ hoặc quốc tế ở bậc THCS. Đây là kết quả của sự đầu tư bài bản, nhất quán và tâm huyết suốt nhiều năm của nhà trường.</p>
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    status: PageStatus.PUBLISHED,
    seo_title: 'Chương trình Quốc gia nâng cao — Vân Cốc',
    seo_description:
...
<p>Chương trình dạy học chính khóa tại trường Tiểu học Vân Cốc được xây dựng trên nền <strong>Chương trình Giáo dục phổ thông 2018</strong> của Bộ GD&ĐT — chương trình quốc gia hiện đại, tiên tiến, được thiết kế theo định hướng phát triển năng lực và phẩm chất người học. Tuy nhiên, nhà trường không dừng lại ở mức chuẩn tối thiểu. Với định hướng <em>nâng cao chất lượng</em>, trường Vân Cốc bổ sung thêm nội dung nâng cao cho hai môn nền tảng quan trọng nhất: <strong>Toán học</strong> và <strong>Tiếng Việt</strong>, giúp học sinh phát triển tư duy logic, ngôn ngữ và nền tảng tri thức vượt trội so với mặt bằng chung.</p>
...
<p>Chất lượng giáo dục của chương trình nâng cao được phản ánh rõ nét qua các con số thực tế: <strong>hơn 40%</strong> học sinh lớp 4–5 đạt giải trong các kỳ thi học sinh giỏi Toán và Tiếng Việt cấp quận và cấp thành phố; tỷ lệ học sinh hoàn thành tốt chương trình tiểu học đạt trên 85% nhiều năm liên tiếp; 100% học sinh tốt nghiệp tiểu học đạt ngưỡng điểm đầu vào các trường THCS top đầu quận Đống Đa. Những thành tích này không đến từ việc nhồi nhét hay học thêm quá nhiều, mà đến từ một nền giáo dục chất lượng, bài bản và tôn trọng sự phát triển tự nhiên của trẻ.</p>
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    status: PageStatus.PUBLISHED,
    seo_title: 'Kỹ năng sống — Chương trình giáo dục toàn diện tại Vân Cốc',
    seo_description:
...
<p>Bên cạnh kiến thức học thuật, <strong>kỹ năng sống</strong> là nền tảng không thể thiếu để một đứa trẻ phát triển thành một người trưởng thành hạnh phúc, tự lập và có ích cho xã hội. Trường Tiểu học Vân Cốc là một trong số ít trường tiểu học tại Hà Nội dành riêng <strong>2 tiết kỹ năng sống mỗi tuần</strong> trong khung chương trình chính khóa — không phải hoạt động ngoài giờ tuỳ chọn, mà là môn học bắt buộc được thiết kế bài bản, có giáo trình rõ ràng và được giảng dạy bởi đội ngũ giáo viên chuyên biệt kết hợp với chuyên gia tâm lý học đường.</p>

<h2>Nội dung chương trình — Toàn diện và thực tiễn</h2>
<p>Chương trình Kỹ năng sống tại Vân Cốc bao gồm 6 nhóm kỹ năng cốt lõi, được phân bổ xuyên suốt 5 năm học theo mức độ từ cơ bản đến nâng cao:</p>
<ul>
